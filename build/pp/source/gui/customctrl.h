...
class Gui : public PbClass {public:
	...
	void nextVec3Display(); static PyObject* _W_19 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::nextVec3Display" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->nextVec3Display();  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::nextVec3Display" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::nextVec3Display",e.what()); return 0; } }
	void nextMeshDisplay(); static PyObject* _W_20 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::nextMeshDisplay" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->nextMeshDisplay();  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::nextMeshDisplay" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::nextMeshDisplay",e.what()); return 0; } }
	void nextPartDisplay(); static PyObject* _W_21 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::nextPartDisplay" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->nextPartDisplay();  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::nextPartDisplay" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::nextPartDisplay",e.what()); return 0; } } 
	void toggleHideGrids(); static PyObject* _W_22 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::toggleHideGrids" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->toggleHideGrids();  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::toggleHideGrids" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::toggleHideGrids",e.what()); return 0; } }
	void setCamPos(float x, float y, float z); static PyObject* _W_23 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::setCamPos" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; float x = _args.get<float >("x",0,&_lock); float y = _args.get<float >("y",1,&_lock); float z = _args.get<float >("z",2,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->setCamPos(x,y,z);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::setCamPos" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::setCamPos",e.what()); return 0; } }
	void setCamRot(float x, float y, float z); static PyObject* _W_24 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::setCamRot" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; float x = _args.get<float >("x",0,&_lock); float y = _args.get<float >("y",1,&_lock); float z = _args.get<float >("z",2,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->setCamRot(x,y,z);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::setCamRot" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::setCamRot",e.what()); return 0; } }  
	void windowSize(int w, int h); static PyObject* _W_25 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Gui* pbo = dynamic_cast<Gui*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Gui::windowSize" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; int w = _args.get<int >("w",0,&_lock); int h = _args.get<int >("h",1,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->windowSize(w,h);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Gui::windowSize" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Gui::windowSize",e.what()); return 0; } }
