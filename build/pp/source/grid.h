...
#line 1 "/home/dalab/workspace/fluid/myManta/source/grid.h"
/******************************************************************************
 *
...
template<class T> class Grid : public GridBase {public:
	...
	T getAt(int i, int j, int k); static PyObject* _W_14 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getAt" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; int i = _args.get<int >("i",0,&_lock); int j = _args.get<int >("j",1,&_lock); int k = _args.get<int >("k",2,&_lock);  pbo->_args.copy(_args);  _retval = toPy(pbo->getAt(i,j,k));  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getAt" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getAt",e.what()); return 0; } }
	void setAt(int i, int j, int k, T val); static PyObject* _W_15 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::setAt" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; int i = _args.get<int >("i",0,&_lock); int j = _args.get<int >("j",1,&_lock); int k = _args.get<int >("k",2,&_lock); T val = _args.get<T >("val",3,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->setAt(i,j,k,val);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::setAt" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::setAt",e.what()); return 0; } }
	
void copyFromFine(int i, int j, int k, Grid<T> &fine, int sizeX, int sizeY, int sizeZ); static PyObject* _W_16 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::copyFromFine" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; int i = _args.get<int >("i",0,&_lock); int j = _args.get<int >("j",1,&_lock); int k = _args.get<int >("k",2,&_lock); Grid<T> & fine = *_args.getPtr<Grid<T>  >("fine",3,&_lock); int sizeX = _args.get<int >("sizeX",4,&_lock); int sizeY = _args.get<int >("sizeY",5,&_lock); int sizeZ = _args.get<int >("sizeZ",6,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->copyFromFine(i,j,k,fine,sizeX,sizeY,sizeZ);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::copyFromFine" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::copyFromFine",e.what()); return 0; } }
	
void copyToFine(int i, int j, int k, Grid<T> &fine, int sizeX, int sizeY, int sizeZ); static PyObject* _W_17 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::copyToFine" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; int i = _args.get<int >("i",0,&_lock); int j = _args.get<int >("j",1,&_lock); int k = _args.get<int >("k",2,&_lock); Grid<T> & fine = *_args.getPtr<Grid<T>  >("fine",3,&_lock); int sizeX = _args.get<int >("sizeX",4,&_lock); int sizeY = _args.get<int >("sizeY",5,&_lock); int sizeZ = _args.get<int >("sizeZ",6,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->copyToFine(i,j,k,fine,sizeX,sizeY,sizeZ);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::copyToFine" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::copyToFine",e.what()); return 0; } }

	// common compound operators
	//! get absolute max value in grid 
	Real getMaxAbs(); static PyObject* _W_18 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getMaxAbs" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = toPy(pbo->getMaxAbs());  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getMaxAbs" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getMaxAbs",e.what()); return 0; } }
	//! get max value in grid 
	Real getMax(); static PyObject* _W_19 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getMax" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = toPy(pbo->getMax());  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getMax" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getMax",e.what()); return 0; } }
	//! get min value in grid 
	Real getMin(); static PyObject* _W_20 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getMin" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = toPy(pbo->getMin());  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getMin" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getMin",e.what()); return 0; } }    
	//! set all boundary cells to constant value (Dirichlet)
	void setBound(T value, int boundaryWidth=1); static PyObject* _W_21 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::setBound" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; T value = _args.get<T >("value",0,&_lock); int boundaryWidth = _args.getOpt<int >("boundaryWidth",1,1,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->setBound(value,boundaryWidth);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::setBound" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::setBound",e.what()); return 0; } }
	//! set all boundary cells to last inner value (Neumann)
	void setBoundNeumann(int boundaryWidth=1); static PyObject* _W_22 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::setBoundNeumann" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock; int boundaryWidth = _args.getOpt<int >("boundaryWidth",0,1,&_lock);  pbo->_args.copy(_args);  _retval = getPyNone(); pbo->setBoundNeumann(boundaryWidth);  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::setBoundNeumann" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::setBoundNeumann",e.what()); return 0; } }

	//! for compatibility, old names:
	Real getMaxAbsValue() { return getMaxAbs(); } static PyObject* _W_23 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getMaxAbsValue" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = toPy(pbo->getMaxAbsValue());  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getMaxAbsValue" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getMaxAbsValue",e.what()); return 0; } }
	Real getMaxValue() { return getMax(); } static PyObject* _W_24 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getMaxValue" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = toPy(pbo->getMaxValue());  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getMaxValue" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getMaxValue",e.what()); return 0; } }
	Real getMinValue() { return getMin(); } static PyObject* _W_25 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { try { PbArgs _args(_linargs, _kwds); Grid* pbo = dynamic_cast<Grid*>(Pb::objFromPy(_self)); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(pbo->getParent(), "Grid::getMinValue" , !noTiming); PyObject *_retval = 0; { ArgLocker _lock;  pbo->_args.copy(_args);  _retval = toPy(pbo->getMinValue());  pbo->_args.check(); } pbFinalizePlugin(pbo->getParent(),"Grid::getMinValue" , !noTiming); return _retval; } catch(std::exception& e) { pbSetError("Grid::getMinValue",e.what()); return 0; } }
...
class MACGrid : public Grid<Vec3> {public:
	MACGrid(FluidSolver* parent, bool show=true) :Grid<Vec3>(parent,show){ 
		mType = (GridType)(TypeMAC | TypeVec3); } static int _W_28 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { PbClass* obj = Pb::objFromPy(_self); if (obj) delete obj; try { PbArgs _args(_linargs, _kwds); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(0, "MACGrid::MACGrid" , !noTiming ); { ArgLocker _lock; FluidSolver* parent = _args.getPtr<FluidSolver >("parent",0,&_lock); bool show = _args.getOpt<bool >("show",1,true,&_lock);  obj = new MACGrid(parent,show); obj->registerObject(_self, &_args); _args.check(); } pbFinalizePlugin(obj->getParent(),"MACGrid::MACGrid" , !noTiming ); return 0; } catch(std::exception& e) { pbSetError("MACGrid::MACGrid",e.what()); return -1; } }
...
class FlagGrid : public Grid<int> {public:
	FlagGrid(FluidSolver* parent, int dim=3, bool show=true) :Grid<int>(parent,show){ 
		mType = (GridType)(TypeFlags | TypeInt); } static int _W_30 (PyObject* _self, PyObject* _linargs, PyObject* _kwds) { PbClass* obj = Pb::objFromPy(_self); if (obj) delete obj; try { PbArgs _args(_linargs, _kwds); bool noTiming = _args.getOpt<bool>("notiming", -1, 0); pbPreparePlugin(0, "FlagGrid::FlagGrid" , !noTiming ); { ArgLocker _lock; FluidSolver* parent = _args.getPtr<FluidSolver >("parent",0,&_lock); int dim = _args.getOpt<int >("dim",1,3,&_lock); bool show = _args.getOpt<bool >("show",2,true,&_lock);  obj = new FlagGrid(parent,dim,show); obj->registerObject(_self, &_args); _args.check(); } pbFinalizePlugin(obj->getParent(),"FlagGrid::FlagGrid" , !noTiming ); return 0; } catch(std::exception& e) { pbSetError("FlagGrid::FlagGrid",e.what()); return -1; } }
